    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span className="font-display text-3xl text-white leading-none">€89,95</span>
            <span className="font-body text-gray-600 text-base line-through leading-none">€129,95</span>
        ...
        <div className="relative flex items-center justify-center lg:justify-end mt-16 lg:mt-0">
          ...
          >
            <Image
              ...
              priority
              style={{ filter: 'drop-shadow(0 50px 80px rgba(0,0,0,0.8)) drop-shadow(0 0 50px rgba(255,140,0,0.15))' }}
            />
          </motion.div>
          ...
          >
            <div className="flex items-center gap-2 mb-0.5">
              ...
              <div className="font-display text-sm uppercase tracking-wide" style={{ color: '#EAB308' }}>50.000mAh</div>
            </div>
            <div className="font-mono-titan text-gray-500 text-xs pl-5">12× smartphone</div>
          </motion.div>
        </div>
      </motion.div>
