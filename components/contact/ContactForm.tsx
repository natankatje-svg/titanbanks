...
export default function ContactForm() {
  ...
  const inputBase =
    'w-full bg-white/[0.03] border border-white/[0.08] rounded-lg px-4 py-3 font-body text-white placeholder:text-[#9C9C9C] focus:outline-none focus:border-[#FF8C00] focus-visible:ring-2 focus-visible:ring-[#FF8C00]/60 focus:bg-white/[0.05] transition-colors';
