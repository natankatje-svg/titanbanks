      ...
      <section className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
        ...
        {children ?? (
          <div className="border border-[#2A2A2A] rounded-lg p-8 bg-[#1A1A1A]/40">
            <p className="font-mono text-xs uppercase tracking-widest text-[#FF8C00] mb-3">
              In ontwikkeling
            </p>
            <p className="text-[#A0A0A0]">
              Deze pagina wordt momenteel gebouwd. Bekijk de{' '}
              <Link href="/preview" className="text-[#FF8C00] underline underline-offset-4">
                interne preview
              </Link>{' '}
              voor de volledige inhoud, of ga naar de{' '}
              <Link href="/" className="text-[#FF8C00] underline underline-offset-4">
                homepage
              </Link>
              .
            </p>
